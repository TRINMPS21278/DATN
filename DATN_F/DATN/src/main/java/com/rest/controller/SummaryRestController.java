...
public class SummaryRestController {
	@Autowired private SanPhamService productService;
	@Autowired private DonHangService orderService;
	@Autowired private ChiTietDonHangService orderDetailService;
	@Autowired private KhachHangService accountService;
	@Autowired private AuthorityService authService;
	
	@Autowired private ChiTietDonHangDAO daodt;
