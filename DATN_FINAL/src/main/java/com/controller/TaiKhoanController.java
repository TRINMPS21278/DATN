...
public class TaiKhoanController {
	...
	public String create(@ModelAttribute TaiKhoan item, Model model, HttpSession session) {
		item.setHinhanh("avatar1.webp");
	...
	public String updateUser(@AuthenticationPrincipal CustomUser loger, @RequestParam("tentaikhoan") String tentaikhoan,
			@RequestParam("ten") String ten, @RequestParam("sdt") String sdt, @RequestParam("email") String email,@RequestParam("hinhanh") String hinhanh ,
